...
!                   1145 1565 1726 1751 2106 2009
	...
	call mvsetflags('X size',900.0)
        print*,"unoooo"
        open (unit = 92, file = "stazione.txt")
        do irec=1,366*24
        do annoi=2007,2016
        do plot=1,3214
           last = 0
	   y1=-9999
!!          plot=4
	  call museoanagrafica('dewrain-fil',plot,com,sens,ylat,ylon)
           
!          print*,"sensore",sens,com,ylat,ylon,plot
	  call museotimeseries('dewrain-fil',plot,annoi,x1,y1,n1)
!          print*, "Valore MASSIMO:: ",maxval(y1)
          do ii=1,366*24*4
            if (y1(ii) > 200) then 
              print*,"stazione: ",com,"Valore:: ",y1(ii),"numero:: ",ii,"ANNO:: ",annoi
             ! call exit(0)
            end if
          end do
!!          WRITE(UNIT=92, FMT=*)y1
!          print*,n1
        end do
        end do
          close(92)
